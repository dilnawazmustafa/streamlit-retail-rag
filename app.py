...
if uploaded_file is not None:
    ...
    # HARDCODED API KEY:
    openai_api_key = "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"
